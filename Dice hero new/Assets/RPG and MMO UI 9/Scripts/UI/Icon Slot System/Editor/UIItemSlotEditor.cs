...
namespace DuloGamesEditor.UI
{
	...
	public class UIItemSlotEditor : UISlotBaseEditor {
        ...
        private SerializedProperty onThrowAwayProperty;
        ...
        protected override void OnEnable()
		{
            ...
            this.onThrowAwayProperty = this.serializedObject.FindProperty("onThrowAway");
		...
		public override void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(this.onThrowAwayProperty, new GUIContent("On ThrowAway"), true);
            this.serializedObject.ApplyModifiedProperties();
		}
	}
}
